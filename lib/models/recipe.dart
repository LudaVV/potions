...
final List<Recipe> recipes = [
  ...
  Recipe(
      ...
      [
        RecipeComponent(foods[16], 200, units[1]),
        RecipeComponent(foods[18], 120, units[3]),
        RecipeComponent(foods[63], 10, units[1]),
        RecipeComponent(foods[32], 6, units[1]),
        RecipeComponent(foods[64], 1, units[0]),
        RecipeComponent(foods[55], 1, units[2]),
        RecipeComponent(foods[65], 60, units[1]),
        RecipeComponent(foods[66], 100, units[1]),
        RecipeComponent(foods[67], 80, units[1]),
      ],
      'Гречку промыть, залить водой. Смена чиа или льна залить теплой водой 10 минут. Гречку измельчить с помощью блендера до однородности, добавить чиа, соль и разрыхлитель.\n'
      'Духовку разогреть до 190С. Жаропрочную форму смазать маслом или выложить пергаментом. Раномерно распределить в форме тесто. Посыпать будущую булочку маком. Запекать в духовке 40-45 минут. Готовый хлеб остудить, достать из формы, отрезать порцию.\n'
      'Разрезать кусок булки вдоль основания на 2 части. Одну намазать творожным сыром. Огурец нарезать тонкими брусочками или лентами. Положить сверху салат, ломтики рыбы, огурец. Накрыть второй половинкой'
  ),
